...
#define ACPI_PCIVGA_OFFSET_EJ0 (*ssdt_pcivga_ej0 - *ssdt_pcivga_start)
...
#define ACPI_PCIQXL_OFFSET_EJ0 (*ssdt_pciqxl_ej0 - *ssdt_pciqxl_start)
...
static void build_pci_bus_end(PCIBus *bus, void *bus_state)
{
    ...
    memset(slot_device_present, 0x00, sizeof slot_device_present);
    memset(slot_device_vga, 0x00, sizeof slot_device_present);
    memset(slot_device_qxl, 0x00, sizeof slot_device_present);
