...
static bool vmstate_test_use_acpi_pci_hotplug(void *opaque)
{
    PIIX4PMState *s = opaque;
    return s->use_acpi_pci_hotplug;
}

static const VMStateDescription vmstate_piix_acpi_pci_hotplug = {
    .name = "piix_acpi_pci_hptplug",
    .version_id = 1,
    .minimum_version_id = 1,
    .minimum_version_id_old = 1,
    .fields      = (VMStateField []) {
...
static const VMStateDescription vmstate_acpi = {
    ...
    .fields      = (VMStateField []) {
        ...
        VMSTATE_STRUCT(pci0_status, PIIX4PMState,
    ...
    .subsections = (VMStateSubsection[]) {
        {
            .vmsd = &vmstate_piix_acpi_pci_hotplug,
            .needed = vmstate_test_use_acpi_pci_hotplug,
        },
        { 0 }
    }
